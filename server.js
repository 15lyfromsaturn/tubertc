...
var indexSource = fs.readFileSync(path.join(__dirname, '/templates/index.html'), 'utf8');
...
tubertcApp.use('/js', express.static(path.join(__dirname, '/public/js')));
tubertcApp.use('/css', express.static(path.join(__dirname, '/public/css')));
tubertcApp.use('/audio', express.static(path.join(__dirname, '/public/audio')));
tubertcApp.use('/images', express.static(path.join(__dirname, '/public/images')));

// Add a route for telemetry scripts
if (debugMode) {
  tubertcApp.use('/telemetry', express.static(path.join(__dirname, '/public/telemetry')));
}
